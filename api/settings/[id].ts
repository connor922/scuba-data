...
var data = [
    [
        ...
        },
        {
            ...
            name: 'Campaign 2',
            state: 'ARCHIVED',
            seniorites: [{ id: 1, name: 'Director', isIncluded: true }],
            keywords: [{ id: 1, name: 'Technology', isIncluded: true }],
            companysList: [{ id: 1, name: 'Google', isIncluded: true }],
            jobTitles: [{ id: 2, name: 'Analyst', isIncluded: false }],
        },
    ],
]
